...
H.on_attach = function (client, bufnr)
  ...
  buf_set_keymap('n', '<leader>gl', '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>', descOpts('LSP show line diagnostics'))
  buf_set_keymap('n', '[d', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>', descOpts('LSP prev diagnostic'))
  buf_set_keymap('n', ']d', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>', descOpts('LSP next diagnostic'))
  buf_set_keymap('n', '<leader>gq', '<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>', descOpts('LSP diagnostic set loclist'))
