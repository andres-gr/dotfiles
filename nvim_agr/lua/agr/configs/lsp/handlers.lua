...
H.on_attach = function (client, bufnr)
  ...
  buf_set_keymap('n', 'gm', '<CMD>Lspsaga show_cursor_diagnostics<CR>', descOpts('LSP show cursor diagnostics'))
  buf_set_keymap('n', 'gl', '<CMD>Lspsaga show_line_diagnostics<CR>', descOpts('LSP show line diagnostics'))
