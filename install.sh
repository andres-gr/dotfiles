...
declare -A PATCH_FUNCTION_DESCRIPTIONS=(
  ...
  [install_cmdline_options]="Install kernel cmdline options"
  ...
  # hyprland
  [configure_monitors_lua]="Generate monitors config file from template"
  ...
  [install_hyprland_config]="Install main Hyprland hyprland.lua"
  ...
  [move_perf_mode]="Move performance mode config to bottom of niri config"
  # dank
